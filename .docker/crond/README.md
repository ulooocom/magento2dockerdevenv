...
docker build -t registry.cn-shanghai.aliyuncs.com/ulooocom/magento2:php-8.1.29-fpm-alpine3.20-cron -f ./.docker/crond/Dockerfile .
```
...
```apacheconf
  php81-cron:
    image: ${ALIYUN_CONTAINER_URL}/magento2:php-8.1.29-fpm-alpine3.20-cron
